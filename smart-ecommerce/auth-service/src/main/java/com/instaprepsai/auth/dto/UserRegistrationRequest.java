...
public class UserRegistrationRequest {
    ...
    @Schema(description = "The role(s) of account. Must be one or more of the following: ROLE_STUDENT, ROLE_TEACHER, ROLE_PARTNER, ROLE_ADMIN, ROLE_SALES, ROLE_OPERATIONS.")
